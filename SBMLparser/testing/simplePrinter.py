import rulifier.componentGroups as componentGroups
import argparse
import pprint
...
class SimplePrinter:
    ...
    def getComplexReactions(self, threshold=1):
        complexRules = []
    ...
    def analyzeComplexReactions(self, threshold=1):
        ...
        for reaction in self.getComplexReactions(threshold):
